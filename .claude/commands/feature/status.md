...
- Folder name (the directory name from the path)
- Branch (from `**Branch:**` line)
- Progress checkboxes (Brief, Blueprint, Implement, E2E, Review, Done lines)
...
[?] Brief — needs your attention
  1. <feature-title> (<MM.DD-slug>)
     [?]Brief  [ ]Blueprint  [ ]Implement  [ ]E2E  [ ]Review  [ ]Done

[x] Brief — ready to blueprint
  2. <feature-title> (<slug>)
     [x]Brief  [ ]Blueprint  [ ]Implement  [ ]E2E  [ ]Review  [ ]Done

[o] Blueprint
  3. <feature-title> (<slug>)
     [x]Brief  [o]Blueprint  [ ]Implement  [ ]E2E  [ ]Review  [ ]Done
